...
<Accordion title="ISoftDeletable">
  Marks a persistence entity as capable of being soft-deleted. The interceptor checks for an `IsDeleted` EF shadow property, not this interface directly, but you can implement it on your data entities for explicit control.
