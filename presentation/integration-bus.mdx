...
description: "Set up MassTransit over RabbitMQ for cross-service integration events, commands, and queries using SharedKernel's MassTransitDependencyInjection and BaseIntegrationEventHandler."
---
